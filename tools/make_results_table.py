...
Point it at runs/metrics/; it groups by filename. Emits Markdown + CSV.
Add --require to fail if an expected arm is missing (for the final table -
e.g. all 4 methods must be present: vanilla, default, set1, set2).
...
SLICE_ORDER = ["overall", "daytime", "night", "dawn_dusk", "rainy"]
...
def main():
    ...
    ap.add_argument("--require", nargs="*", default=[],
                    help="metric-file stems that must exist (e.g. default_100_test)")
    args = ap.parse_args()
