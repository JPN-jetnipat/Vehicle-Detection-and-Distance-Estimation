# ---------------------------------------------------------------------------
# PROVENANCE: this file is a VERBATIM copy of the Method 2 (IRFS sampling) arm's
# `compute_repeat_factors.py`, taken from `irfs_augmentation/` on 2026-08-22.
# It is copied rather than reimplemented on purpose: Method 3 is the composition
# of Methods 1 and 2, so its oversampling must be produced by byte-identical
# math, not by an independent reimplementation that happens to agree. If the
# Method 2 arm's copy is ever changed, re-copy it here and re-run
# tools/build_method3_split.py -- do not edit this file locally.
#
