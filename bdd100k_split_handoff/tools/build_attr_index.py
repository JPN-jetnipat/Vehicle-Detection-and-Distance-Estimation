...
Ported unchanged from the old project (Path B) - this step has no
class-list or split-rule dependency, so there was nothing to adapt.

Consumed by tools/make_splits.py to do the undefined-cleaning and the
timeofday-stratified train/val split.
